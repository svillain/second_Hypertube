...
<html>
	...
	<!-- Topbar Navigation -->
		<div class="topnav" id="myTopnav">
			<a class="navbar-brand" href="#"><img src="<?php echo $picturep?>" alt="profile picture" style="width:40px;"></a>
	...
	<!-- Movies -->
		...
		<div id="main_body" style="margin-left: 5%;"></div>
		<div id="movie_result" style="text-align: center;"></div>
		</br>
    	<div id="comment"></div>
	<!-- Fin Movies -->
			...
			getMovieDataPromise(arr,"info").then(function(movie) {
				...
				window.title = result.Title;
					...
					`<div class="card-header">
						<h4 id="movieName" class="card-title" style="color: white !important;">`+ result.Title+ `</h4>
						`+ originalTitle +`
