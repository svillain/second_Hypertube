...
<html>
	...
	<!-- Topbar Navigation -->
		<div class="topnav" id="myTopnav">
			<a class="navbar-brand" href="#"><img src="<?php echo $profilep ?>" alt="profile picture" style="width:40px;"></a>
			...
			<center>
				<div class="topnav-centered">
					<a href="#"><img src="images/logo_topnav.png" alt="logo" height="50%" width="50%"></a>
				</div>
			</center>
				...
				<center>
					<div class="card border-secondary mb-3 form-group" id="sortandfiltercard" onmouseover="movieHoverIn(this)" onmouseout="movieHoverOut(this)">
						...
						<!-- SORT -->
							...
							<!-- SORT by name -->
								<div class="custom-control custom-radio col-sm">
									<input type="radio" id="sortFormRadio2" name="sortFormRadio" class="custom-control-input sort fieldinput" value="title">
								...
								<div class="custom-control custom-radio col-sm">
									...
									<div id="sortFormYear" class="fieldinput">
										<select id="sortFormYearSelector">
											<option class="" value="asc" >Oldest - Newest</option>
									...
									<label class="custom-control-label" for="sortFormRadio4"> Rating </label>
										<div id="sortFormRating" class="">
											<select id="sortFormRatingSelector" class="fieldinput">
												<option class="" value="desc" selected>Highest - Lowest</option>
												<option class="" value="asc">Lowest - Highest</option>
											</select>						
										</div>
								</div>
							<!-- Fin SORT by rating -->
...
<script src="./js/showMoviehelpers.js"></script>
<script type="text/javascript">
